...
const DriverDetails = () => {
        ...
        switch(e.target.name){
            ...
            case 'firstName':
                if(e.target.value){
                    ...
                    setFirstName({value: '', error:'Please enter FirstName'})
                }
                break;
            case 'lastName':
                if(e.target.value){
                    ...
                    setLastName({value: '', error:'Please enter LarstName'})
                }
                break;
            case 'DOB':
                if(e.target.value){
                    setDOB({value:e.target.value, error: ''})
                    // console.log(e.target.value)
                }
                else{
                    setDOB({value: '', error:'Please enter valid date of birth'})
                }
                break;
            case 'maritalstatus':
                if(e.target.value){
                    setMaritalstatus({value:e.target.value, error: ''})
                    // console.log(e.target.value)
                }
                else{
                    setMaritalstatus({value: '', error:'Please enter Merital Status'})
                }
                break;
            case 'homeowner':
                if(e.target.value){
                    setHomeowner({value:e.target.value, error: ''})
                    // console.log(e.target.value)
                }
                else{
                    setHomeowner({value: '', error:'Choose a valid option from the list'})
                }
                break;
            case 'occupation':
                if(e.target.value){
                    setOccupation({value:e.target.value, error: ''})
                    // console.log(e.target.value)
                }
                else{
                    setOccupation({value: '', error:'Please enter occupation'})
                }
                break;
            case 'dropdowndemployeestatus':
                if(e.target.value){
                    setDropdowndemployeestatus({value:e.target.value, error: ''})
                    // console.log(e.target.value)
                }
                else{
                    setDropdowndemployeestatus({value: '', error:'Please enter employee status'})
                }
                break;
            case 'business_type':
                if(e.target.value){
                    setBusiness_type({value:e.target.value, error: ''})
                    // console.log(e.target.value)
                }
                else{
                    setBusiness_type({value: '', error:'Please enter business type'})
                }
                break;
            case 'driverexperienceyear':
                if(e.target.value){
                    setDriverexperienceyear({value:e.target.value, error: ''})
                    // console.log(e.target.value)
                }
                else{
                    setDriverexperienceyear({value: '', error:'Please enter experienvce in year'})
                }
                break;
            case 'driverexperiencemonth':
                if(e.target.value){
                    setDriverexperiencemonth({value:e.target.value, error: ''})
                    // console.log(e.target.value)
                }
                else{
                    setDriverexperiencemonth({value: '', error:'Please enter experience in months'})
                }
                break;
            case 'postCode':
                if(e.target.value){
                    setPostCode({value:e.target.value, error: ''})
                    // console.log(e.target.value)
                }
                else{
                    setPostCode({value: '', error:'Please enter business type'})
                }
                break;
            default:
                console.log('nothing')    
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if(title.value && !title.error && firstName.value && !firstName.error && lastName.value && !lastName.error && DOB.value && !DOB.error && maritalstatus.value && !maritalstatus.error && homeowner.value && !homeowner.error && occupation.value && !occupation.error && dropdowndemployeestatus.value && !dropdowndemployeestatus.error && business_type.value && !business_type.error && driverexperienceyear.value && !driverexperienceyear.error && driverexperiencemonth.value && !driverexperiencemonth.error && postCode.value && !postCode.error){
            // setSubmitError('')
            ...
            // setSubmitError('Please enter all fields valid data...')
            console.log('Please enter all fields valid data...')
        }
    }
                        ...
                        <div className="vds-form-journey__main">
                            ...
                            <div className="vds-form-journey__main">
                                ...
                                <div className="vds-form__group vds-form__group--accordion vds-form__group--form-journey">
                                    ...
                                    <div className>
                                        <input autoComplete="off" className="vds-form__input" id="first_name_input" type="firstName" name="firstName" maxLength={35} placeholder="Please enter" spellCheck="false" data-hj-suppress="true" onChange={handleInputChange}/>
                                        {/* defaultValue */}
                                        {firstName.error && 
                                ...
                                <div className="vds-form__group vds-form__group--accordion vds-form__group--form-journey">
                                    ...
                                    <div className>
                                        <input autoComplete="off" className="vds-form__input" id="last_name_input" type="lastName" name="lastName" maxLength={35} placeholder="Please enter" spellCheck="false" data-hj-suppress="true" onChange={handleInputChange}/>
                                        {lastName.error && 
                                ...
                                <div className="vds-form__group vds-form__group--accordion vds-form__group--form-journey">
                                    <div className="vds-form__group vds-form__group--form-journey">
                                        ...
                                        <input className="vds-form__input vds-form__input--uppercase " pattern="[0-9]*" inputMode="numeric" placeholder="DD/MM/YYYY" name="DOB" id="dateofbirth_input" autoComplete="off" data-hj-suppress="true" onChange={handleInputChange}/>
                                        {DOB.error && 
                                ...
                                <div className="vds-form__group vds-form__group--accordion vds-form__group--form-journey">
                                    ...
                                    <select id="maritalstatus_dropdown" className="vds-form__input vds-form__input--select " name="maritalstatus" data-hj-suppress="true" onChange={handleInputChange}>
                                        <option value="Please choose">Please choose</option>
                                ...
                                <div className="vds-form__group vds-form__group--accordion vds-form__group--form-journey">
                                    ...
                                    <select id="home_owner_dropdown" className="vds-form__input vds-form__input--select " name="homeowner" data-hj-suppress="true" onChange={handleInputChange}>
                                        <option value="Please choose">Please choose</option>
                                ...
                                <div className="vds-form__group vds-form__group--accordion vds-form__group--form-journey">
                                    ...
                                    <div className="vds-autocomplete">
                                        <div role="combobox" aria-haspopup="listbox" aria-owns="react-autowhatever-1" aria-expanded="false" className="autosuggest__container">
                                            <input type="text" autoComplete="off" aria-autocomplete="list" aria-controls="react-autowhatever-1" className="vds-form__input " placeholder="e.g. Financial advisor" name="occupation" onChange={handleInputChange}/>
                                ...
                                {/* vds-form__group--disabled */}
                                    ...
                                    <select id="employee_status_dropdown" className="vds-form__input vds-form__input--select "  name="dropdowndemployeestatus" data-hj-suppress="true" onChange={handleInputChange}>
                                        <option value="Please choose">Please choose</option>
                                ...
                                {/* vds-form__group--disabled */}
                                    ...
                                    <div className="vds-autocomplete">
                                        <div role="combobox" aria-haspopup="listbox" aria-owns="react-autowhatever-1" aria-expanded="false" className="autosuggest__container">
                                            <input type="text" autoComplete="off" aria-autocomplete="list" aria-controls="react-autowhatever-1" className="vds-form__input " placeholder="e.g. Finance Company" id="business_type" name="business_type"  onChange={handleInputChange}/>
                                            <div id="react-autowhatever-1" role="listbox" className="autosuggest__suggestions-container" />
                                ...
                                <div className="vds-form__group vds-form__group--accordion vds-form__group--form-journey">
                                    ...
                                    <div className="vds-form__group vds-form__group--inline">
                                        <div className="vds-form__group-section vds-form__group-section--full-width">
                                            ...
                                            <select id="driver_experience_year_dropdown" className="vds-form__input vds-form__input--select " name="driverexperienceyear" data-hj-suppress="true" onChange={handleInputChange}>
                                        ...
                                        <div className="vds-form__group-section vds-form__group-section--full-width">
                                            ...
                                            <select id="driver_experience_month_dropdown" className="vds-form__input vds-form__input--select " name="driverexperiencemonth" data-hj-suppress="true" onChange={handleInputChange}>
                                ...
                                <div className="vds-form__group vds-form__group--form-journey-button">
                                    <div>
                                        ...
                                        <div className>
                                            <input autoComplete="off" className="vds-form__input " id="address_lookup_input" type="text" name="postCode" maxLength={8} placeholder="e.g. ST47 1EY" spellCheck="false" data-hj-suppress="true" onChange={handleInputChange}/>
                                            {/* name="text" */}
                                            {postCode.error && 
